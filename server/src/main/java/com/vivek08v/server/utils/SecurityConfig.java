    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/manage-menu/menu-details").hasAnyRole("ADMIN", "CUST")
                .requestMatchers("/api/v1/manage-menu/add-menu-details").hasRole("ADMIN")
                .requestMatchers("/api/v1/manage-menu/edit-menu-details").hasRole("ADMIN")
